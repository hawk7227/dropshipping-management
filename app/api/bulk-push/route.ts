  ...
  return {
    product: {
      ...
      metafields: [
        ...
        ...(p.competitorPrices ? [
          { namespace: 'comparisons', key: 'price_amazon', value: String(p.competitorPrices.amazon || 0), type: 'number_decimal' },
          { namespace: 'comparisons', key: 'price_costco', value: String(p.competitorPrices.costco || 0), type: 'number_decimal' },
          { namespace: 'comparisons', key: 'price_ebay', value: String(p.competitorPrices.ebay || 0), type: 'number_decimal' },
          { namespace: 'comparisons', key: 'price_samsclub', value: String(p.competitorPrices.sams || 0), type: 'number_decimal' },
        ] : []),
      ],
    },
  };
