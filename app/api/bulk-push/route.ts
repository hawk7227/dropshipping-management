  ...
  return {
    product: {
      ...
      metafields: [
        ...
        ...(p.competitorPrices ? [
          { namespace: 'compare_prices', key: 'amazon_price', value: String(p.competitorPrices.amazon || 0), type: 'number_decimal' },
          { namespace: 'compare_prices', key: 'costco_price', value: String(p.competitorPrices.costco || 0), type: 'number_decimal' },
          { namespace: 'compare_prices', key: 'ebay_price', value: String(p.competitorPrices.ebay || 0), type: 'number_decimal' },
          { namespace: 'compare_prices', key: 'sams_price', value: String(p.competitorPrices.sams || 0), type: 'number_decimal' },
        ] : []),
      ],
    },
  };
