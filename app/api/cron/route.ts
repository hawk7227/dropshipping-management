      ...
      switch (jobType) {
        ...
        case 'shopify-sync': {
          ...
          const { data: unsyncedProducts } = await supabase
            .from('products')
            .select('id, asin, title, brand, category, product_type, description, image_url, images, rating, review_count, retail_price, cost_price, amazon_price, compare_at_price, status, tags')
