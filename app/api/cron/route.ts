                ...
                const shopifyPayload = {
                  product: {
                    ...
                    metafields: [
                      ...
                      (product.source_url || product.asin) ? { namespace: 'custom', key: 'supplier_url_flow_access', value: product.source_url || `https://www.amazon.com/dp/${product.asin}`, type: 'single_line_text_field' } : null,
                      (product.source_url || product.asin) ? { namespace: 'custom', key: 'supplier_url', value: product.source_url || `https://www.amazon.com/dp/${product.asin}`, type: 'single_line_text_field' } : null,
                    ].filter(Boolean),
                  }
                };
