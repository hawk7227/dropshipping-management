...
makeModal" onClick={closeModal}>
        <div className="modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal-content">
            ...
            <div className="make-test-section">
              <label className="modal-label">Test Connection</label>
              <button className="modal-btn secondary" style={{width: '100%'}} onClick={testMakeConnection}>
                <span>🔗</span>
                <span>Test Webhook Connection</span>
              </button>
              {makeTestResult.show && (
                <div className={`make-test-result ${makeTestResult.type}`} id="makeTestResult">{makeTestResult.message}</div>
              )}
            </div>

            <div className="modal-actions" style={{marginTop: '24px'}}>
              <button className="modal-btn primary" onClick={saveMakeSettings}>
                <span>💾</span>
